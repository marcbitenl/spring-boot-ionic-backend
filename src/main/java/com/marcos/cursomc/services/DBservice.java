...
public class DBservice {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcbitenl@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "marcbitenl@outlook.com", "23260204563", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("97894556", "45123678"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano","2106", null, "Centro", "15877012", cli2, c2);
